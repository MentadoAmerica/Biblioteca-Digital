...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="{{ route('libros.store')}}" method="POST" class="bg-white shadow-md rounded-lg p-6">
        ...
        <div class="mb-4">
            <label for="nombre" class="block text-gray-700 font-bold mb-2">ISBN:</label>
        ...
        <div class="mb-4">
            <label for="nombre" class="block text-gray-700 font-bold mb-2">Autor:</label>
        ...
        <div class="mb-4">
            <label for="nombre" class="block text-gray-700 font-bold mb-2">Editorial:</label>
        ...
        <div class="mb-4">
            <label for="nombre" class="block text-gray-700 font-bold mb-2">Categoria:</label>
