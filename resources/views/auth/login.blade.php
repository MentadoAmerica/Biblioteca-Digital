...
<main class="flex-grow py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-12">
            <div class="mx-auto bg-blue-600 w-14 h-14 rounded-xl flex items-center justify-center mb-6 shadow-lg shadow-blue-500/30">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
            </div>
            <h1 class="text-3xl md:text-4xl font-bold text-slate-900 mb-3">Biblioteca Municipal</h1>
            <p class="text-slate-500 text-lg">Accede a tu cuenta o regístrate para disfrutar de todos nuestros servicios</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="remember" class="w-4 h-4 text-blue-600 bg-slate-50 border-slate-300 rounded focus:ring-blue-500">
                        <label for="remember" class="ml-2 text-sm text-slate-600">Recordar sesión</label>
                    </div>

                    <button type="submit" class="w-full bg-slate-900 hover:bg-slate-800 text-white font-semibold py-3 px-4 rounded-lg transition-colors flex justify-center items-center gap-2">
                ...
                <div class="mt-8 relative">
                    ...
                    <div class="relative flex justify-center text-sm"><span class="px-2 bg-white text-slate-500">O</span></div>
                </div>

                <div class="mt-6 flex gap-4">
                    <button class="flex-1 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-medium py-2.5 px-4 rounded-lg transition-colors flex justify-center items-center gap-2 shadow-sm">
                    ...
                    <button class="flex-1 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-medium py-2.5 px-4 rounded-lg transition-colors flex justify-center items-center gap-2 shadow-sm">
                        <svg class="w-5 h-5 text-blue-600" fill="currentColor" viewBox="0 0 24 24"><path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z"/></svg>
                        Facebook
                    </button>
                </div>

                <p class="mt-8 text-sm text-slate-600">
                    ¿No tienes una cuenta? <a href="#" class="text-blue-600 font-semibold hover:underline">Regístrate aquí</a>
                </p>

                <div class="mt-6 bg-blue-50/50 border border-blue-100 rounded-xl p-5">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                <div class="mb-8">
                    ...
                    <p class="text-sm text-slate-500 mt-1">Regístrate para acceder a todos los servicios</p>
                </div>
    ...
    @endif
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name='name' placeholder="Tu nombre" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-slate-700 placeholder-slate-400">
                        </div>
                    ...
                    <div>
                        ...
                        <input type="email"  name='email' placeholder="usuario@ejemplo.com" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-slate-700 placeholder-slate-400">
                        <p class="text-xs text-slate-400 mt-1">Usaremos este email para contactarte</p>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            <label for='password' class="block text-sm font-medium text-slate-700 mb-1 flex items-center gap-2">
                                <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                                Contraseña
                            </label>
                            <input type="password"  name='password' placeholder="Crea una contraseña" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-slate-700 placeholder-slate-400">
                            <p class="text-xs text-slate-400 mt-1">Mínimo 6 caracteres</p>
                        </div>
                        <div>
                            <label for='password_confirmation' class="block text-sm font-medium text-slate-700 mb-1 flex items-center gap-2">
                                <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                                Repetir Contraseña
                            </label>
                            <input type="password"  name='password_confirmation' placeholder="Repite tu contraseña" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-slate-700 placeholder-slate-400">
                        </div>
                    </div>

                    <div class="flex items-start mt-6">
                        <div class="flex items-center h-5">
                            <input type="checkbox" id="terms" class="w-4 h-4 text-blue-600 bg-slate-50 border-slate-300 rounded focus:ring-blue-500 mt-0.5">
                        </div>
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-medium text-slate-600">
                                Acepto los <a href="#" class="text-blue-600 hover:underline">términos y condiciones</a> y la política de privacidad de la Biblioteca Municipal. Confirmo que soy mayor de 14 años.
                            </label>
                        </div>
                    </div>

                    <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors flex justify-center items-center gap-2 mt-4 shadow-md shadow-blue-500/20">
                ...
                <p class="mt-8 text-sm text-slate-600">
                    Ya tienes una cuenta? <a href="#" class="text-blue-600 font-semibold hover:underline">Inicia sesión aquí</a>
                </p>
            </div>
